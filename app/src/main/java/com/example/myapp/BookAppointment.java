...
private static Spinner sp_healthprovider;
 ...
 appttime.setOnClickListener(new View.OnClickListener() {
     ...
     public void onClick(View v) {
         ...
         // time picker dialog
         picker = new TimePickerDialog(BookAppointment.this,
        ...
        Spinner sp_healthprovider = (Spinner) findViewById(R.id.sp_healthprovider);
        ArrayAdapter<String> healthprovideradapter = new ArrayAdapter<String>(BookAppointment.this, R.layout.spinner_appts,getResources().getStringArray(R.array.health_providers));
        healthprovideradapter.setDropDownViewResource(R.layout.spinner_dropdown_item);
        sp_healthprovider.setAdapter(healthprovideradapter);
        sp_healthprovider.setPrompt("Select Health Provider");
